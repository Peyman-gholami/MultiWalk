...
if __name__ == "__main__":
    ...
    parser.add_argument('--algorithm', type=str, choices=['random_walk', 'async_gossip', 'async_gossip_general', 'split_random_walk', 'fedavg', 'scaffold', 'huscaffold', 'sgfocus'], required=True,
